...
html,body{margin:0}
body{min-height:100vh;min-height:100dvh;display:flex;align-items:center;justify-content:center;padding:24px;font-family:system-ui,-apple-system,"Segoe UI",sans-serif;color:#e2e8f0;
  background:radial-gradient(120% 85% at 50% 0%,rgba(11,16,30,.38) 0%,rgba(11,16,30,.74) 58%,rgba(11,16,30,.94) 100%),url('/smart-meal/img/hero-food.webp') center/cover no-repeat fixed,#0b1120}
.phase{width:100%}
...
@media(prefers-reduced-motion:reduce){.r{animation:none;opacity:1}.btn.big{animation:none}}
</style></head>
<body>
